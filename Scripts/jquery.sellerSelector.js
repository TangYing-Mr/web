...
',
    ...
    reload: function (selectedShopIds) {
        ...
        $("#_shopSelector table").dnxbmallDatagrid({
            url: url,
            nowrap: false,
            rownumbers: true,
        ...
        $("#_shopSelector .choose-search button").unbind('click').click(function () {
            ...
            $("#_shopSelector table").dnxbmallDatagrid('reload', $.sellerSelector.params);
        });
    ...
    getSelected: function () {
        ...
        if (this.multiSelect) {
            ...
            shops.push($("#_shopSelector table").dnxbmallDatagrid('getSelected'));
        }
        return shops;
    },
