...
',
    ...
    reload: function (shopId, selectedProductIds) {
        ...
        $("#_shopProductSelector table").dnxbmallDatagrid({
            url: url,
            nowrap: false,
            rownumbers: true,
        ...
        $("#_shopProductSelector .choose-search button").unbind('click').click(function () {
            ...
            $("#_shopProductSelector table").dnxbmallDatagrid('reload', $.shopProductSelector.params);
        });
    ...
    getSelected: function () {
        ...
        if (this.multiSelect) {
            ...
            products.push($("#_shopProductSelector table").dnxbmallDatagrid('getSelected'));
        }
    ...
    show: function (selectedProductIds, onSelectFinishedCallBack, shopId, multiSelect) {
        ...
        $('#_shopProductSelector select').dnxbmallLinkage({
            ...
            onChange: function (level, value) {
                ...
                if (level > 0 && !value) {
                    ...
                    categoryId = $('#_shopProductSelector select').dnxbmallLinkage('value', parentLevel);
