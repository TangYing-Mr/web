...
',
    ...
    reload: function (selectedProductIds, exceptProductIds) {
        ...
        $("#_productSelector table").dnxbmallDatagrid({
            url: url,
            nowrap: false,
            rownumbers: true,
        ...
        $("#_productSelector .choose-search button").unbind('click').click(function () {
            ...
            $("#_productSelector table").dnxbmallDatagrid('reload', $.productSelector.params);
        });
    ...
    getSelected:function(){
        ...
        if (this.multiSelect) {
            ...
            products.push($("#_productSelector table").dnxbmallDatagrid('getSelected'));
        }
        return products;
    },
    show: function (selectedProductIds, onSelectFinishedCallBack, serviceType, multiSelect, exceptProductIds) {
        ...
        $('#_productSelector select').dnxbmallLinkage({
            url: curl,
            ...
            onChange: function (level, value) {
                ...
                if (level > 0 && !value)
                {
                    ...
                    categoryId = $('#_productSelector select').dnxbmallLinkage('value', parentLevel);
