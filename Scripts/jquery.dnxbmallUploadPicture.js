...
(function ($) {
	...
	$.fn.dnxbmallUploadPic = function (options, param) {
	    if (typeof options == "string") {
	        return $.fn.dnxbmallUploadPic.methods[options](this, param);
	    }
	    options = options || {};
	    return this.each(function () {
	        var opts = $.extend({}, $.fn.dnxbmallUploadPic.defaults, options);
	        opts.view.render.call(opts.view, opts, $(this));
	        bindEvent(this, opts);
	    });
	};

	$.fn.dnxbmallUploadPic.methods = {
