...
(function ($) {
    ...
    $.fn.dnxbmallUpload = function (options, param) {
        if (typeof options == "string") {
            return $.fn.dnxbmallUpload.methods[options](this, param);
        }
        options = options || {};
        return this.each(function () {
            var opts = $.extend({}, $.fn.dnxbmallUpload.defaults, options);
