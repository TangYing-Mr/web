(function ($) {
    ...
    function initLoad() {
        var html = '';
        initTable();
        $.post($.fn.dnxbmallCategoryTree.options.dataUrl, { parentId: 0 }, function (data) {
    ...
    $.fn.dnxbmallCategoryTree = function (options) {
        container = $(this);
        $.fn.dnxbmallCategoryTree.options = $.extend({}, $.fn.dnxbmallCategoryTree.options, options);
    ...
    $.fn.dnxbmallCategoryTree.options = {
        dataUrl: null,
        updateUrl: null,
        deleteUrl: null,
        batchDeleteUrl: null,
