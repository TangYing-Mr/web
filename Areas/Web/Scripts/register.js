...
function checksysCheckCodeIsValid() {
    ...
    var pluginId = "Dnxbmall.Plugin.Message.SMS";
    var ischeckemail = ($("#ischeckemail").val() == 1);
    var ischecktel = ($("#ischecktel").val() == 1);
    if (ischeckemail) {
        pluginId = "Dnxbmall.Plugin.Message.Email";
...
function checkCheckCodeIsValid() {
    ...
    //        type: "post",
    //        url: "/register/CheckCode",
    //        data: { pluginId: "Dnxbmall.Plugin.Message.SMS", code: checkCode, destination: $("#cellPhone").val() },
    //        dataType: "json",
    //        async: false,
    //        success: function (data) {
    //            if (data.success == true) {
...
function sendmCode() {
    ...
    jQuery.ajax({
        type: "post",
        url: "/Register/SendCode?pluginId=Dnxbmall.Plugin.Message.SMS&destination=" + $("#cellPhone").val(),
...
function sendemCode() {
    ...
    jQuery.ajax({
        type: "post",
        url: "/Register/SendCode?pluginId=Dnxbmall.Plugin.Message.Email&destination=" + $("#callEmail").val(),
        success: function (result) {
            if (result.success == true) {
                $("#callEmail_error").hide();
