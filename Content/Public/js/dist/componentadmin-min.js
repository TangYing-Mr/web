var Dnxbmall = Dnxbmall ? Dnxbmall : {};
Dnxbmall.Constant = Dnxbmall.Constant ? Dnxbmall.Constant : {},
Dnxbmall.popbox = Dnxbmall.popbox ? Dnxbmall.popbox : {},
Dnxbmall.linkType = {
    1: "选择商品",
    2: "优惠劵",
    3: "专题页面",
...
Dnxbmall.FormShowError = function (a, b, c) {
...
Dnxbmall.changeWizardStep = function (a, b) {
    var c = $(a),
...
Dnxbmall.autoLocation = function (a, b) {
    if (a) {
        var b = b ? b : 2e3;
...
Dnxbmall.ajaxPopTable = function (a) {
    var b, c, d = {
        title: "",
        url: "",
        data: {
    ...
    g = function (a) {
        ...
        $.ajax({
            ...
            data: e.data,
            success: function (a) {
                1 == a.status ? i(a) : Dnxbmall.hint("danger", "对不起，获取数据失败：" + a.msg)
            }
        })
    };
    g(function () {
...
Dnxbmall.popbox.ImgPicker = function (a) {
    ...
    e = function (a, c) {
        ...
        $.ajax({
            url: Dnxbmall.Config.getImgList,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
            ...
            success: function (a) {
                1 == a.status ? f(a) : Dnxbmall.hint("danger", "对不起，获取数据失败：" + a.msg)
            }
        })
    },
    f = function (b) {
        ...
        d.find("#imgpicker_upload_input").uploadify({
            ...
            onSelectError: function (a, b, c) {
                switch (b) {
                    case -100: Dnxbmall.hint("danger", "对不起，系统只允许您一次最多上传10个文件");
                        break;
                    case -110: Dnxbmall.hint("danger", "对不起，文件 [" + a.name + "] 大小超出5MB！");
                        break;
                    case -120: Dnxbmall.hint("danger", "文件 [" + a.name + "] 大小异常！");
                        break;
                    case -130: Dnxbmall.hint("danger", "文件 [" + a.name + "] 类型不正确！")
                }
            },
            onFallback: function () {
                Dnxbmall.hint("danger", "您未安装FLASH控件，无法上传图片！请安装FLASH控件后再试。")
            },
            ...
            onUploadError: function (a, b, c, d) {
                Dnxbmall.hint("danger", "对不起：" + a.name + "上传失败：" + d)
            }
        }),
...
Dnxbmall.popbox.IconPicker = function (a) {
    ...
    g = function (a) {
        f = a ? a : f;
        var b = _.template(e)({
            data: Dnxbmall.popbox.iconimgsrc.data[f.style][f.color]
        });
    ...
    d.find("#j-useIcon").click(function (b) {
        ...
        if (0 == c.length) return Dnxbmall.hint("danger", "对不起，请选择一张小图标"),
        !1;
...
Dnxbmall.popbox.ModulePicker = function (a) {
...
Dnxbmall.popbox.GoodsAndGroupPicker = function (a, b) {
    ...
    i = function (a, b) {
        ...
        $.ajax({
            ...
            url: Dnxbmall.Config.AjaxUrl.goodsList,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
            ...
            success: function (a) {
                1 == a.status ? d(a) : Dnxbmall.hint("danger", "对不起，获取数据失败：" + a.msg)
            }
        })
    },
    j = function (a, b) {
        ...
        /*s*/
        $.ajax({
            url: Dnxbmall.Config.AjaxUrl.goodGroup,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
            ...
            success: function (a) {
                1 == a.status ? c(a) : Dnxbmall.hint("danger", "对不起，获取数据失败：" + a.msg)
            }
        })
    },
    k = function (a, c) {
                        ...
                        function (a) {
                            ...
                            e = function (a, i) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (a) {
                                        1 == a.status ? j(a) : Dnxbmall.hint("danger", "对不起，获取数据失败：" + a.msg)
                                    }
                                })
                            };
                            e()
...
Dnxbmall.popbox.MgzAndMgzCate = function (a, b) {
...
Dnxbmall.popbox.GamePicker = function (a, b) {
    ...
    f = function (a, b, c) {
        ...
        $.ajax({
            url: Dnxbmall.Config.AjaxUrl.gamesUrl,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(b),
            ...
            success: function (a) {
                1 == a.status ? g(a) : Dnxbmall.hint("danger", "对不起，获取数据失败：" + a.msg)
            }
        })
    },
    g = function (a, c) {
...
Dnxbmall.popbox.CouponPicker = function (a, b) {
    ...
    f = function (a, b, c) {
        ...
        $.ajax({
            url: Dnxbmall.Config.AjaxUrl.Coupons,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(b),
...
Dnxbmall.popbox.PointExchangePicker = function (a, b) {
    ...
    f = function (a, b, c) {
        ...
        $.ajax({
            url: Dnxbmall.Config.AjaxUrl.PointExChanges,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(b),
...
Dnxbmall.popbox.VotePicker = function (a, b) {
    ...
    f = function (a, b, c) {
        ...
        $.ajax({
            url: Dnxbmall.Config.AjaxUrl.Votes,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(b),
...
Dnxbmall.popbox.GraphicPicker = function (a, b) {
    ...
    i = function (a, b) {
        ...
        $.ajax({
            ...
            url: Dnxbmall.Config.AjaxUrl.Graphics,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
...
Dnxbmall.popbox.CategoriesPicker = function (a, b) {
    ...
    i = function (a, b) {
        ...
        $.ajax({
            ...
            url: Dnxbmall.Config.AjaxUrl.Categories,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
...
Dnxbmall.popbox.BrandsPicker = function (a, b) {
    ...
    i = function (a, b) {
        ...
        $.ajax({
            ...
            url: Dnxbmall.Config.AjaxUrl.Brands,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
...
Dnxbmall.popbox.CustomLink = function ( b) {
 ...
 Dnxbmall.popbox.IsURL = function (str_url) {
...
,
Dnxbmall.popbox.dplPickerColletion = function (a) {
    var b = {
        linkType: 1,
        callback: null
    },
    ...
    switch (parseInt(c.linkType)) {
        case 1: //专题页面
            Dnxbmall.popbox.GoodsAndGroupPicker("goods", c.callback);
            break;
        case 2: //商品
            Dnxbmall.popbox.CouponPicker("all", c.callback);
            break;
        case 3: //现金红包
            Dnxbmall.popbox.CategoriesPicker("all", c.callback);
            break;
        case 4: //限时购列表
            Dnxbmall.popbox.BrandsPicker("all", c.callback);
            break;
        case 5: //优惠券
            Dnxbmall.popbox.GamePicker("all", c.callback);
            break;
        case 6: //微店首页
            var d = {
                title: "微店首页",
        ...
        case 7: //签到
            ...
            break;
        case 8: //自定义链接
            Dnxbmall.popbox.CustomLink(c.callback);
            break;
    }
},
Dnxbmall.ajaxPopTable = function (a) {
...
$(function () {
    ...
    try {
        ...
        b = function () {
            Dnxbmall.Constant.windowHeight = $(this).height(),
            Dnxbmall.Constant.windowWidth = $(this).width(),
            Dnxbmall.Constant.containerOffset = a.offset(),
            Dnxbmall.Constant.containerWidth = a.outerWidth()
        },
        c = function () {
           $("#j-gotop").css("left", Dnxbmall.Constant.containerWidth + Dnxbmall.Constant.containerOffset.left + 10)  
        };
...
function (a, b, c) {
    ...
    GetImgList = function (b, c, d, e) {
        ...
        a.ajax({
            url: Dnxbmall.Config.AjaxUrl.getImgList,
            type: "post",
            dataType: "json",
            data: i,
            beforeSend: function () {
            ...
            success: function (d) {
                ...
                } else Dnxbmall.hint("danger", "对不起，图片获取失败：" + d.msg)
            }
        })
    },
    UpdateTreeNums = function (b) {
//alert(Dnxbmall.Config.AjaxUrl.getFolderTree);
        a.ajax({
            url: Dnxbmall.Config.AjaxUrl.getFolderTree,
            type: "post",
            dataType: "json",
            success: function (a) {
                if (1 == a.status) {
    ...
    a.albums = function (c) {
        ...
        if (!f.length) {
            ...
            a.ajax({
                ...
                success: function (b) {
                    ...
                    } else Dnxbmall.hint("danger", "对不起，文件夹获取失败：" + b.msg)
                }
            }),
            ...
            f.on("click", "#j-useImg",
            function () {
                if (!f.find("#j-panelImgs li.selected").length) return void Dnxbmall.hint("warning", "请选择图片！");
                var b = [];
            ...
            i.click(function () {
                ...
                a.ajax({
                    url: Dnxbmall.Config.AjaxUrl.addFolder,
                    type: "post",
                    dataType: "json",
                    data: {
                        name: b.name,
                    ...
                    success: function (c) {
                        if (1 == c.status) {
                            ...
                            j.click()
                        } else Dnxbmall.hint("danger", "对不起，添加失败：" + c.msg)
                    }
                })
            }),
            j.click(function () {
                ...
                d.blur(function () {
                    var b = a(this).val();
                    a.ajax({
                        url: Dnxbmall.Config.AjaxUrl.renameFolder,
                        type: "post",
                        dataType: "json",
                        data: {
                            name: b,
                        ...
                        success: function (a) {
                            1 == a.status ? c.find(".j-name").text(b) : Dnxbmall.hint("danger", "对不起，重命名失败：" + a.msg),
                            c.show(),
                            d.hide(),
                            e.hide()
                        }
                ...
                a.jBox.show({
                    ...
                    btnOK: {
                        onBtnClick: function (b) {
                            ...
                            a.ajax({
                                url: Dnxbmall.Config.AjaxUrl.delFolder,
                                type: "post",
                                dataType: "json",
                                data: {
                                    type: c,
                                ...
                                success: function (a) {
                                    if (1 == a.status) {
                                        ...
                                        b.remove()
                                    } else Dnxbmall.hint("danger", "对不起，删除失败失败：" + a.msg)
                                }
                            }),
                            a.jBox.close(b)
                        }
            ...
            o.click(function () {
                if (!f.find("#j-panelImgs li.selected").length) return void Dnxbmall.hint("warning", "请选择要删除的图片！");
                var b = [];
                f.find("#j-panelImgs li.selected").each(function () {
                    b.push(a(this).data("id"))
                }),
                a.ajax({
                    url: Dnxbmall.Config.AjaxUrl.delImg,
                    type: "post",
                    dataType: "json",
                    data: {
                        file_id: b
                    ...
                    success: function (b) {
                        ...
                        function () {
                            a(this).remove()
                        }), UpdateTreeNums(f)) : Dnxbmall.hint("danger", "对不起，删除失败：" + b.msg)
                    }
                })
            }),
            l.uploadify({
                ...
                multi: !0,
                swf: "/Content/Public/plugins/uploadify/uploadify.swf",
                uploader: Dnxbmall.Config.AjaxUrl.addImg+Dnxbmall.getAreaName(),
                buttonText: "上传图片",
                fileSizeLimit: "5MB",
                fileTypeExts: "*.jpg; *.jpeg; *.png; *.gif; *.bmp",
            ...
            m.click(function () {
                if (!f.find("#j-panelImgs li.selected").length) return void Dnxbmall.hint("warning", "请选择要移动的图片！");
                ...
                a.jBox.show({
                    ...
                    btnOK: {
                        onBtnClick: function (b) {
                            ...
                            a.ajax({
                                url: Dnxbmall.Config.AjaxUrl.moveImg,
                                type: "post",
                                dataType: "json",
                                data: {
                                    file_id: c,
                                ...
                                success: function (b) {
                                    ...
                                    function () {
                                        a(this).remove()
                                    }), UpdateTreeNums(f), Dnxbmall.hint("success", "恭喜您，操作成功！")) : Dnxbmall.hint("danger", "对不起，移动失败：" + b.msg)
                                }
                            }),
                            a.jBox.close(b)
                        }
            ...
            n.click(function () {
                if (!Cache.folderID) return void Dnxbmall.hint("warning", "请选择要移动的分类！");
                var b = a("<div class='albums-cl-tree j-albumsNodes j-propagation'></div>");
                b.append(p.find("dd:first").contents().clone()),
                a.jBox.show({
                    title: "请选择移动文件夹",
                    ...
                    btnOK: {
                        onBtnClick: function (b) {
                            a.ajax({
                                url: Dnxbmall.Config.AjaxUrl.moveCateImg,
                                type: "post",
                                dataType: "json",
                                data: {
                                    cid: Cache.folderID,
        ...
        function () {
            ...
            return a.ajax({
                url: Dnxbmall.Config.AjaxUrl.renameImg,
                type: "post",
                dataType: "json",
                data: {
                    file_id: c,
                ...
                success: function (a) {
                    1 == a.status ? (b.closest(".albums-edit").children(".img-name-edit").hide(), b.closest(".albums-edit").children("p").html(d), b.closest(".albums-edit").children("input.file_name").val(d), Dnxbmall.hint("success", "恭喜您，操作成功！")) : Dnxbmall.hint("danger", "对不起，操作失败")
                }
            }),
            !1
        }),
