...
Dnxbmall.popbox.LimitBuyPicker = function (a, b) {
   ...
   i = function (a, b) {
       ...
       $.ajax({
           ...
           url: Dnxbmall.Config.AjaxUrl.LimitBuy,
           type: "post",
           dataType: "json",
           data: {
               p: parseInt(a)
...
Dnxbmall.popbox.TopicPicker = function (a, b) {
    ...
    i = function (a, b) {
        ...
        $.ajax({
            ...
            url: Dnxbmall.Config.AjaxUrl.Topic,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
...
Dnxbmall.popbox.BonusPicker = function (a, b) {
    ...
    i = function (a, b) {
        ...
        $.ajax({
            ...
            url: Dnxbmall.Config.AjaxUrl.Bonus,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
...
Dnxbmall.popbox.dplPickerColletion = function (a) {
    ...
    switch (parseInt(c.linkType)) {
        ...
        case 2: //优惠券
            ...
            break;
        case 3: //专题
            Dnxbmall.popbox.TopicPicker("all", c.callback);
            break;
        //case 4: //现金红包
        //    Dnxbmall.popbox.BonusPicker("all", c.callback);
        //    break;
        case 5: //限时购列表
            Dnxbmall.popbox.LimitBuyPicker("all", c.callback);
            break;
        //case 6: //微店首页
        //    var d = {
        //        title: "微店首页",
...
Dnxbmall.popbox.CustomLink = function (a) {
...
function (a, b, c) {
    ...
    GetImgList = function (b, c, d, e) {
        ...
        a.ajax({
            url: Dnxbmall.Config.AjaxUrl.getImgList + "?" + Dnxbmall.getAreaName(),
            type: "post",
            dataType: "json",
            data: i,
            beforeSend: function () {
    ...
    UpdateTreeNums = function (b) {
        ...
        a.ajax({
            url: Dnxbmall.Config.AjaxUrl.getFolderTree + "?" + Dnxbmall.getAreaName(),
            type: "post",
            dataType: "json",
            success: function (a) {
                if (1 == a.status) {
    ...
    a.albums = function (c) {
        ...
        if (!f.length) {
            ...
            i.click(function () {
                ...
                a.ajax({
                    url: Dnxbmall.Config.AjaxUrl.addFolder + "?" + Dnxbmall.getAreaName(),
                    type: "post",
                    dataType: "json",
                    data: {
                        name: b.name,
