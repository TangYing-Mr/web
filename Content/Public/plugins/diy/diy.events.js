$(function () {
    //模块类型1 富文本
    Dnxbmall.DIY.Unit.event_type1 = function (ctrldom, data) {
        ...
        data.ue.ready(function () {
            data.ue.setContent(Dnxbmall.DIY.Unit.html_decode(data.content.fulltext)); //设置编辑器的默认值
            ...
            var reSetVal = function () {
                ...
                data.content.fulltext = Dnxbmall.DIY.Unit.html_encode(val); //更新到缓存
            }
    ...
    //模块类型2 标题
    Dnxbmall.DIY.Unit.event_type2 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom; //控制内容
    ...
    //模块类型3 自定义模块
    Dnxbmall.DIY.Unit.event_type3 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom; //控制内容
        ...
        //修改事件
        var modify = function () {
            Dnxbmall.popbox.ModulePicker(function (module) {
    ...
    //模块类型4 商品
    Dnxbmall.DIY.Unit.event_type4 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function (callback) {
            ...
            Dnxbmall.DIY.Unit.event_type4($ctrl, data);
        ...
        $ctrl.find(".j-addgoods").click(function () {
            Dnxbmall.popbox.GoodsAndGroupPicker("goodsMulti", function (list) {
    ...
    //模块类型5 商品列表（分组标签）
    Dnxbmall.DIY.Unit.event_type5 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function () {
            ...
            Dnxbmall.DIY.Unit.event_type5($ctrl, data);
        }
        ...
        $ctrl.find(".j-btn-add,.j-btn-modify").click(function () {
            Dnxbmall.popbox.GoodsAndGroupPicker("group", function (group) {
    ...
    //模块类型7 文本导航
    Dnxbmall.DIY.Unit.event_type7 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function () {
            ...
            Dnxbmall.DIY.Unit.event_type7($ctrl, data);
        }
        ...
        $ctrl.find(".droplist li").click(function () {
            ...
            Dnxbmall.popbox.dplPickerColletion({
    ...
    //模块类型8 图片导航
    Dnxbmall.DIY.Unit.event_type8 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function (callback) {
            ...
            Dnxbmall.DIY.Unit.event_type8($ctrl, data);
            if (callback) callback();
        }
        ...
        $ctrl.find(".j-selectimg").click(function () {
            ...
            Dnxbmall.popbox.ImgPicker(function (imgs) {
    ...
    //模块类型9 广告图片
    Dnxbmall.DIY.Unit.event_type9 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function () {
            ...
            Dnxbmall.DIY.Unit.event_type9($ctrl, data);
        }
    ...
    //模块类型11 辅助空白
    Dnxbmall.DIY.Unit.event_type11 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function () {
            ...
            Dnxbmall.DIY.Unit.event_type11($ctrl, data);
        }
    ...
    //模块类型12 顶部导航
    Dnxbmall.DIY.Unit.event_type12 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function () {
            ...
            Dnxbmall.DIY.Unit.event_type12($ctrl, data);
        }
        ...
        $ctrl.find(".j-navModifyIcon").click(function () {
            ...
            //     reRender();
            // });
            Dnxbmall.popbox.IconPicker(function (imgs) {
                console.log(imgs)
                data.content.dataset[index].pic = imgs[0];
                reRender();
            });
    ...
    //模块类型13 橱窗
    Dnxbmall.DIY.Unit.event_type13 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
        ...
        var reRender = function (callback) {
            ...
            var $render_ctrl = $(_.template(tpl_ctrl, data));
            $ctrl.empty().append($render_ctrl);
            Dnxbmall.DIY.Unit.event_type13($ctrl, data);
            if (callback) callback();
        }
        // 设置宽高
